...
A lo largo del análisis se desarrolla:

- Carga y exploración inicial de datos (EDA).  
- Preprocesamiento y limpieza de datos.  
- Transformación de variables.  
- Aplicación del modelo GMM.  
- Selección del número óptimo de clusters (AIC y BIC).  
- Interpretación de resultados.  
- Visualización de segmentos.  

Este trabajo ha sido desarrollado con el objetivo de aplicar técnicas avanzadas de Machine Learning a problemas reales de negocio.
